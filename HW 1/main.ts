//
interface IPerson {FirstName:string,MiddleName:string,LastName: string}
...
let FirstName:string ='Liudmyla';
let MiddleName:string ='Mykolaivna';
let LastName:string = 'Lavrekha';
...
let arr:number [] = [21,33,100,450,-90,450];
console.log(arr);
let arrSt:string [] = ['21','33','100','450','-90','450'];
console.log(arrSt);

let arrN: Array<number> = [1, 2, 3, 4, 5];
console.log(arrN);

let arrS: Array<string> = ['1', '2', '3', '4', '5'];
console.log(arrS);


type dateType ={year:number,month:number,day:number};

let date:dateType = {year: 2025, month: 3, day:31};
console.log(date);
...
let parr:(string | number)[] = [1, '2', '3', 4, 5];
console.log(parr);


type productsType = {title:string, price:number};
...
type listOfItemsType = string;

let listOfItems:listOfItemsType[] =
